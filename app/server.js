...
const { expressNunjucks, getNunjucksAppEnv, stopWatchingNunjucks } = require('../node_modules/govuk-prototype-kit/lib/nunjucks/nunjucksConfiguration')
...
// Local dependencies
const { projectDir, packageDir, finalBackupNunjucksDir } = require('../node_modules/govuk-prototype-kit/lib/utils/paths')
const config = require('../node_modules/govuk-prototype-kit/lib/config.js').getConfig()
const packageJson = require('../node_modules/govuk-prototype-kit/package.json')
const utils = require('../node_modules/govuk-prototype-kit/lib/utils')
const sessionUtils = require('../node_modules/govuk-prototype-kit/lib/session.js')
const plugins = require('../node_modules/govuk-prototype-kit/lib/plugins/plugins.js')
const routesApi = require('../node_modules/govuk-prototype-kit/lib/routes/api.js')
...
require('../node_modules/govuk-prototype-kit/lib/plugins/plugins-routes.js')
const { getErrorModel } = require('../node_modules/govuk-prototype-kit/lib/utils/errorModel')
...
app.use((err, req, res, next) => {
  ...
  switch (err.status) {
    case 404: {
      ...
      res.render('error-handling/page-not-found', {
        path
      })
      break
    }
    default: {
      res.status(500)
      console.error(err.message)
      res.render('error-handling/server-error', getErrorModel(err))
      break
    }
  }
})
